                ...
                <div className="card">
                    ...
                    <div className="card_content">
                        <div className="card_text">
                            ...
                            <p> <span  className='tokenDetails'> property Price:</span> {tokens?.propertyPrice}</p>
                            <p> <span  className='tokenDetails'> owner Name:</span> {tokens?.ownerName}</p>
                            <p> <span  className='tokenDetails'> Address:</span> {tokens?.propertyAddress}</p>
                        </div>
