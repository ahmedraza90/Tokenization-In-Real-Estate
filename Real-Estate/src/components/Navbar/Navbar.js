    ...
    <div>
      ...
      <nav>
        ...
        <ol>
          ...
          {!address && <li>
            <button onClick={connectHandler} style={{ width: "165px", height: "55px", color: "white", borderRadius: "10px", background: "#109272", border: "2px white", boxShadow: "#f9fafb26 1px 1px 12px 4px" }}>Connect Wallet</button>
          </li>}
          <li>
